...
def recommend_portfolio(intent_request):
    ...
    if (int(age) >= 65) | (int(age) <= 0):
        return {
        "isValid": False,
        "violatedSlot": "age",
        "message": {"contentType": "PlainText", "content": "Please provide an age between 0 and 65"},
        }
        
    if (int(investment_amount) < 5000):
        return {
        "isValid": False,
        "violatedSlot": "investment_amount",
        "message": {"contentType": "PlainText", "content": "Please provide an investment amount greater than $5000"},
        }
    ...
    if risk_level == "None":
        ...
        return "Please pick a risk level of None, Low, Medium, or High"
